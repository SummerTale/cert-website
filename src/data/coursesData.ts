...
function createCourse(courseData: {
  ...
  return {
    ...
    type: courseData.type || "Corporate Workshop",
...
export const courses: Course[] = [
  ...
  createCourse({
    id: 23,
    avatar: "/course-logo/value-stream.png",
    role: "Management",
    slug: "value-stream-corporate-workshop",
    title: "Value Stream Corporate Workshop",
    duration: "2 days",
    level: "Intermediate",
    certificate: "Value Stream Workshop Completion Certificate",
    price: "$1000",
    rating: 4.7,
    reviews: 89,
    effort: "2 days",
    ...
    instructorCerts: ["SPC", "CSP", "Value Stream Consultant"],
    learnings: [
      "Implementing practices and optimizing organizations for continuous value flow",
      "Focusing on business value provided to the customer",
      "Value stream coordination for managing competing requirements",
      "Scaling value stream practices for complex organizations",
      "Applying SAFe techniques for coordination and interconnection"
    ],
  }),

  createCourse({
    id: 24,
    avatar: "/course-logo/safe-portfolio-management.png",
    role: "Management",
    slug: "safe-portfolio-management",
    title: "SAFe® Portfolio Management",
    duration: "2 days",
    level: "Advanced",
    certificate: "SAFe Portfolio Management Workshop Completion Certificate",
    price: "$1000",
    rating: 4.8,
    reviews: 76,
    effort: "2 days",
    ...
    instructorCerts: ["SPC", "CSP", "SAFe Portfolio Management"],
    learnings: [
      "Establishing portfolio vision and Lean portfolio budgeting",
      "Using portfolio tools like Portfolio Kanban",
      "Managing enterprise-wide portfolio of Agile projects",
      "Applying SAFe techniques to actual business challenges",
      "Deep dive into organizational complexities and solutions"
    ],
  }),

  createCourse({
    id: 25,
    avatar: "/course-logo/backlog-increment.png",
    role: "Developer",
    slug: "program-increment-workshop",
    title: "Program Increment Workshop",
    duration: "3 days",
    level: "Intermediate",
    certificate: "Program Increment Workshop Completion Certificate",
    price: "$1500",
    rating: 4.6,
    reviews: 94,
    effort: "3 days",
    length: "24 hours",
    prerequisites: "Previous experience in an IT organization highly desired, whether from actual industry experience or theory.",
    instructorCerts: ["SPC", "CSP", "SAFe Program Consultant"],
    learnings: [
      "Defining program increments and guiding development cycles",
      "Setting realistic goals for program increments",
      "Ensuring sprints deliver program increment functionality",
      "Utilizing program increments for continuous improvement",
      "Realizing functionality through deployment and value delivery"
    ],
  }),

  createCourse({
    id: 26,
    avatar: "/course-logo/inspect-adapt.png",
    role: "Management",
    slug: "inspect-adapt",
    title: "Inspect & Adapt",
    duration: "3 days",
    level: "Intermediate",
    certificate: "Inspect & Adapt Workshop Completion Certificate",
    price: "$1500",
    rating: 4.7,
    reviews: 82,
    effort: "3 days",
    length: "24 hours",
    prerequisites: "Experience in Agile team environment recommended",
    instructorCerts: ["SPC", "CSP", "Agile Coach"],
    learnings: [
      "Implementing regular reflection and tuning in Agile environments",
      "Identifying backlog items for improvement",
      "Demonstrating program increments and measuring benefits",
      "Mastering the process of reflection and continuous improvement",
      "Bolstering culture of continuous learning and adaptation"
    ],
  }),

  createCourse({
    id: 27,
    avatar: "/course-logo/product-management.png",
    role: "Product Manager",
    slug: "product-management-workshop",
    title: "Product Management Workshop",
    duration: "3 days",
    level: "Advanced",
    certificate: "Product Management Workshop Completion Certificate",
    price: "$1500",
    rating: 4.8,
    reviews: 78,
    effort: "3 days",
    length: "24 hours",
    prerequisites: "Previous experience as a manager in an IT organization highly desired, whether from actual industry experience or theory.",
    instructorCerts: ["SPC", "CSP", "Product Management Expert"],
    learnings: [
      "Setting clear vision for Agile teams and guiding backlogs",
      "Maintaining alignment with business goals in Agile environment",
      "Identifying and prioritizing features for iterative development",
      "Managing backlogs and realizing program increment goals",
      "Adapting product management for fast-moving self-organized teams"
    ],
  }),

  createCourse({
    id: 28,
    avatar: "/course-logo/team-building.png",
    role: "Management",
    slug: "team-building-workshop",
    title: "Team Building Workshop",
    duration: "1 day",
    level: "Beginner",
    certificate: "Team Building Workshop Completion Certificate",
    price: "$500",
    rating: 4.9,
    reviews: 145,
    effort: "1 day",
    length: "8 hours",
    prerequisites: "None",
    instructorCerts: ["CSP", "Team Building Facilitator", "Agile Coach"],
    learnings: [
      "Building team cohesion and connectedness",
      "Participating in team-building activities and interactive discussions",
      "Appreciating unique contributions of each team member",
      "Identifying individual strengths and maximizing team effectiveness",
      "Forming bonds and strengthening team collaboration"
    ],
  }),

  createCourse({
    id: 29,
    avatar: "/course-logo/custom-scrum.png",
    role: "Developer",
    slug: "customized-scrum-kanban-workshop",
    title: "Customized Scrum/Kanban Workshop",
    duration: "1 day",
    level: "Beginner",
    certificate: "Scrum/Kanban Workshop Completion Certificate",
    price: "$500",
    rating: 4.6,
    reviews: 112,
    effort: "1 day",
    ...
    instructorCerts: ["CSP", "PMP", "Scrum/Kanban Expert"],
    learnings: [
      "Kanban best practices and implementation strategies",
      "Creating and using Kanban boards effectively",
      "Scrum framework, values, roles, and events",
      "Applying Scrum principles in working environments",
      "Incorporating Agile practices with current team workflows"
    ],
  }),
